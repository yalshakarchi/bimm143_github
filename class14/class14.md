...
> Q. What will rowSums() of countData return and how could you use it in
> this context?

Answer: It shows us the sum of all values for each row and in this
context it shows us the counts of each genes and filters out the genes
that are zero (no expression).
...
> Q. Q. Call the summary() function on your results to get a sense of
...
```
    ...
    Info: Working in directory /Users/yasoohaitham/BIMM 143/bimm143_github/class14
...
Answer: The most significant “Entities p-value” is in Cell Cycle,
Mitotic. Yes it matches my KEGG result. Something that can cause it to
be different is that the databases can be different (annotated
differently/ filtered differently) causing it to not have the same exact
file ( therefore not same output).
